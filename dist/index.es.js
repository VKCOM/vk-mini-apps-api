var e = ["VKWebAppInit", "VKWebAppGetCommunityAuthToken", "VKWebAppAddToCommunity", "VKWebAppGetUserInfo", "VKWebAppSetLocation", "VKWebAppGetClientVersion", "VKWebAppGetPhoneNumber", "VKWebAppGetEmail", "VKWebAppGetGeodata", "VKWebAppSetTitle", "VKWebAppGetAuthToken", "VKWebAppCallAPIMethod", "VKWebAppJoinGroup", "VKWebAppAllowMessagesFromGroup", "VKWebAppDenyNotifications", "VKWebAppAllowNotifications", "VKWebAppOpenPayForm", "VKWebAppOpenApp", "VKWebAppShare", "VKWebAppShowWallPostBox", "VKWebAppScroll", "VKWebAppResizeWindow", "VKWebAppShowOrderBox", "VKWebAppShowLeaderBoardBox", "VKWebAppShowInviteBox", "VKWebAppShowRequestBox", "VKWebAppAddToFavorites"],
    ...
    i = o && window.webkit && void 0 !== window.webkit.messageHandlers && void 0 !== window.webkit.messageHandlers.VKWebAppClose,
    r = o ? window.AndroidBridge : void 0,
    p = i ? window.webkit.messageHandlers : void 0,
    a = o && !r && !p,
    s = a ? "message" : "VKWebAppEvent";
o && (window.CustomEvent || (window.CustomEvent = function () {
  function e(e, n) {
    var t = n || {
      bubbles: !1,
      cancelable: !1,
  ...
  return e.prototype = Event.prototype, e;
}()), window.addEventListener(s, function () {
  for (var e = [], o = arguments.length; o--;) e[o] = arguments[o];

  var i = [].concat(n);

  if (a && e[0] && "data" in e[0]) {
    var r = function (e, n) {
      var t = {};

      for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && -1 === n.indexOf(o) && (t[o] = e[o]);

      return t;
    }(e[0].data, ["webFrameId", "connectVersion"]);

    r.type && "VKWebAppSettings" === r.type ? t = r.frameId : i.forEach(function (e) {
      e({
        detail: r
      });
    });
  } else i.forEach(function (n) {
    n.apply(null, e);
  });
}));
...
var d,
    u = function (e, n) {
  void 0 === n && (n = {}), r && "function" == typeof r[e] && r[e](JSON.stringify(n)), p && p[e] && "function" == typeof p[e].postMessage && p[e].postMessage(n), a && parent.postMessage({
    handler: e,
    params: n,
    type: "vk-connect",
    webFrameId: t,
    connectVersion: "1.5.6-beta.13-promise"
  }, "*");
},
    c = function (e) {
  n.push(e);
  ...
  var t,
    ...
    resolve: function (e, n, t) {
      var i = o[e];
      i && (t(n) ? i.resolve(n) : i.reject(n), o[e] = null);
    }
  });
  return n(function (e) {
  ...
  supports: function (n) {
    return !(!r || "function" != typeof r[n]) || !(!p || !p[n] || "function" != typeof p[n].postMessage) || !(p || r || !e.includes(n));
  }
};

"object" == typeof exports && "undefined" != typeof module || ((d = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : void 0).vkConnect = f, d.vkuiConnect = f);
...
var createVKMiniAppAPI = function (options) {
    var connect = options.customConnect == null ? f : options.customConnect;
    return new VKMiniAppAPI(connect);
};

export { createVKMiniAppAPI };
